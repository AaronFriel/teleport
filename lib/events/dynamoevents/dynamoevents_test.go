...
func TestConfig_SetFromURL(t *testing.T) {
	useFipsCfg := &Config{
		UseFIPSEndpoint: types.ClusterAuditConfigSpecV2_FIPSEnabled,
	}
	cases := []struct {
		name         string
		url          string
	...
	}{
		{
			...
			cfgAssertion: func(t *testing.T, config *Config) {
				require.Equal(t, types.ClusterAuditConfigSpecV2_FIPSEnabled, config.UseFIPSEndpoint)
			},
		},
		{
			...
			cfgAssertion: func(t *testing.T, config *Config) {
				require.Equal(t, types.ClusterAuditConfigSpecV2_FIPSDisabled, config.UseFIPSEndpoint)
		...
		},
		{
			...
			cfgAssertion: func(t *testing.T, config *Config) {
				require.Equal(t, types.ClusterAuditConfigSpecV2_FIPSUnset, config.UseFIPSEndpoint)
			},
		},
		{
