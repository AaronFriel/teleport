...
var (
	fipsToAWS = map[types.ClusterAuditConfigSpecV2_FIPSEndpointState]endpoints.FIPSEndpointState{
		types.ClusterAuditConfigSpecV2_FIPSUnset:    endpoints.FIPSEndpointStateUnset,
		types.ClusterAuditConfigSpecV2_FIPSEnabled:  endpoints.FIPSEndpointStateEnabled,
		types.ClusterAuditConfigSpecV2_FIPSDisabled: endpoints.FIPSEndpointStateDisabled,
	}
)
